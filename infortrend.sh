...
export IFT_RAID_POOLS_NAME=LV0
export IFT_RAID_LOG_IN=ift
export IFT_RAID_PASSWORD=""
export IFT_RAID_IP=172.27.124.193
...
#Test CLI
#java -jar /opt/bin/Infortrend/raidcmd_ESDS10.jar 172.27.124.193 show lv
